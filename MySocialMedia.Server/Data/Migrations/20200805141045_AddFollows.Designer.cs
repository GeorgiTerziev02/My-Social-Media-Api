...
namespace MySocialMedia.Server.Data.Migrations
{
    ...
    [Migration("20200805141045_AddFollows")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MySocialMedia.Server.Data.Models.Follow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MySocialMedia.Server.Data.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MySocialMedia.Server.Data.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MySocialMedia.Server.Data.Models.Follow", b =>
                {
                    b.HasOne("MySocialMedia.Server.Data.Models.User", "Follower")
                        .WithMany()
